...
def main():
    ...
    EPOCHS = 100
    LEARNING_RATE = 0.05
    NUM_CLUSTERS = 6 # Cardboard, Glass, Metal, Paper, Plastic, Trash
    ...
    # 4. Initialize Competitive Network
    # Input dimension is 512 for ResNet-18 before fc layer
    net = CompetitiveNetwork(input_dim=512, num_clusters=NUM_CLUSTERS, learning_rate=LEARNING_RATE)
    
    # 5. Train the Network Unsupervised
    net.train_network(features, epochs=EPOCHS)

    # 6. Predict Clusters
    print("Clustering data...")
    # Normalize features for final prediction
