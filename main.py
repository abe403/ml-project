...
def main():
    ...
    if not os.path.exists(DATASET_DIR) or len(os.listdir(DATASET_DIR)) == 0:
        print(f"Error: No se encontró el dataset en '{DATASET_DIR}'.")
        print("Por favor, descarga el dataset Trashnet desde Kaggle:")
        print("https://www.kaggle.com/datasets/feyzazkefe/trashnet/data")
        print("Y extráelo de modo que las carpetas 'cardboard', 'glass', etc. estén dentro de './dataset/'.")
        return
    ...
    print("Evaluando y graficando resultados...")
    evaluate_clustering(true_labels, predicted_clusters, class_names, output_dir="./results")
    print("Proceso completado exitosamente. Revisa la carpeta ./results/.")
